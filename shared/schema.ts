...
export const insertTwilioSettingsSchema = createInsertSchema(twilioSettings).omit({ id: true, updatedAt: true });
export const insertWidgetSettingsSchema = createInsertSchema(widgetSettings).omit({ id: true, updatedAt: true });
...
export const insertRoomBookingSchema = createInsertSchema(roomBookings).omit({ id: true, createdAt: true, updatedAt: true });
export const insertTeamMemberSchema = createInsertSchema(teamMembers).omit({ id: true });
export const insertBusinessHourSchema = createInsertSchema(businessHours).omit({ id: true });
export const insertClosureSchema = createInsertSchema(closures).omit({ id: true, createdAt: true });
export const insertKnowledgeBaseItemSchema = createInsertSchema(knowledgeBaseItems).omit({ id: true, createdAt: true });
export const insertPaymentSettingSchema = createInsertSchema(paymentSettings).omit({ id: true, updatedAt: true });
export const insertAiProviderSettingSchema = createInsertSchema(aiProviderSettings).omit({ id: true, updatedAt: true });
...
export type TwilioSetting = typeof twilioSettings.$inferSelect;
export type InsertTwilioSetting = z.infer<typeof insertTwilioSettingsSchema>;
export type WidgetSetting = typeof widgetSettings.$inferSelect;
export type InsertWidgetSetting = z.infer<typeof insertWidgetSettingsSchema>;
...
export type InsertAiProviderSetting = z.infer<typeof insertAiProviderSettingSchema>;
