...
const faqItemsCol1 = [
  ...
  { q: "Can I buy additional workspaces?", a: "Yes. On the Pro plan you get 3 workspaces, Agency gives you 7, and Enterprise includes 20. Additional workspaces can be purchased on any plan." },
  ...
  { q: "What is a workspace?", a: "A workspace is an isolated client environment — their own dashboard, their own content, their own rank tracking, their own reports. Each workspace is completely separate from the others. Solo includes 1, Pro includes 3, Agency includes 7, and Enterprise includes 20." },
  { q: "Can I charge my clients more than I pay for IndexFlow?", a: "That's exactly the point. At $199/month for Pro with 3 workspaces, each workspace costs you ~$66. Most agencies charge $99–$299/month per client for SEO tooling. Two clients at $100/month and you've broken even. Agency at $349/month for 7 workspaces drops that to ~$50 per workspace. IndexFlow is designed to be a profit centre, not a cost." },
  { q: "How does the $1 trial work exactly?", a: "Pay $1 today and get full access to the Pro tier for 30 days — all 40+ tools, 3 workspaces, full white label branding. No feature restrictions, no watermarks, no sandbox mode. The real thing from day one so you can set up client workspaces and see the value immediately." },
            ...
            <FadeIn className="w-full">
              <div className="flex justify-center w-full" data-testid="hero-stats-slim">
                <div className="relative border border-white/15 rounded-2xl sm:rounded-full px-4 sm:px-8 py-2 sm:py-2.5 inline-flex">
                  <div className="grid grid-cols-2 sm:flex sm:items-center sm:justify-center gap-x-3 gap-y-1.5 sm:gap-x-5 text-[7px] portrait:text-[10px] sm:text-[10px] font-semibold tracking-wider sm:tracking-[0.15em] text-white whitespace-nowrap uppercase">
