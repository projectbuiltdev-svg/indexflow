...
const pricingPlans = [
  ...
  },
  {
    ...
    features: ["5 users", "25 workspaces", "Bulk campaigns", "Everything in Solo", "Full white-label branding", "Client-facing dashboards", "Reseller licence included", "Priority support"],
  ...
  },
  {
    ...
    features: ["10 users", "50 workspaces", "Full white label", "Everything in Pro", "Advanced API access", "Priority onboarding call", "Dedicated account manager"],
    cta: "Get Started →",
    featured: false,
  },
  {
    ...
    features: ["20 users", "Unlimited workspaces", "Super Admin Dashboard", "Dedicated support", "Custom contracts", "White glove onboarding", "SLA guarantees", "Co-marketing options"],
    cta: "Talk To Us →",
    featured: false,
    isCustom: true,
  },
...
const compareNew = [
  "$99–$999/month. Pay for what you use.",
...
const faqItemsCol1 = [
  ...
  { q: "Can I buy additional workspaces?", a: "Yes. On the Pro plan you get 25 workspaces, Agency gives you 50, and Enterprise includes unlimited. Additional workspaces can be purchased on any plan." },
  ...
  { q: "Is there annual pricing?", a: "Yes. Pay annually and get 2 months free (pay for 10, get 12). Solo drops to $83/mo, Pro to $166/mo, Agency to $291/mo, and Enterprise to $833/mo. The easiest way to reduce your costs without changing anything else." },
  ...
  { q: "What happens after the $1 trial?", a: "After 30 days you choose the plan that fits — Solo at $99, Pro at $199, Agency at $349, or Enterprise at $999. No automatic charges at a higher rate, no surprise fees. If you decide it's not for you, cancel before day 30 and you pay nothing more. We'd rather earn your business than trap it." },
  ...
  { q: "What is a workspace?", a: "A workspace is an isolated client environment — their own dashboard, their own content, their own rank tracking, their own reports. Each workspace is completely separate from the others. Solo includes 1, Pro includes 25, Agency includes 50, and Enterprise includes unlimited." },
  { q: "Can I charge my clients more than I pay for IndexFlow?", a: "That's exactly the point. At $199/month for Pro with 25 workspaces, each workspace costs you ~$8. Most agencies charge $99–$299/month per client for SEO tooling. Two clients at $100/month and you've already 25×'d your investment. Agency at $349/month for 50 workspaces drops that to ~$7 per workspace. IndexFlow is designed to be a profit centre, not a cost." },
  { q: "How does the $1 trial work exactly?", a: "Pay $1 today and get full access to the Solo plan for 14 days — all 40+ tools, 1 workspace, Google Indexing Automation, Rank Tracker with 1,000 keywords. No feature restrictions, no watermarks, no sandbox mode. The real thing from day one so you can see the value immediately." },
...
const faqItemsCol2 = [
  { q: "How many keywords can I track?", a: "1,000 keywords per workspace, tracked weekly. That's significantly more generous than Ahrefs Lite (750 total) or Semrush Starter, both of which cost more than IndexFlow Solo on their own — before you count the 39 other tools you're not paying for separately." },
  { q: "What's the difference between Pro and Agency?", a: "Scale and team size. Pro gives you 5 users and 25 workspaces — ideal for a small team managing up to 25 clients. Agency gives you 10 users and 50 workspaces with advanced API access, a dedicated account manager, and priority onboarding — built for teams running serious volume." },
  ...
  { q: "What does Enterprise include?", a: "20 users, unlimited workspaces, unlimited domains, custom API integrations, dedicated infrastructure, Super Admin dashboard, named account manager, SLA guarantees, custom contracts, and co-marketing options. $999/month." },
  { q: "Can team members have different permission levels?", a: "Yes. You control what each team member can see and do across workspaces. Assign roles so staff can manage their own client accounts without accessing others. Pro supports 5 users, Agency supports 10, and Enterprise supports 20 with full Super Admin controls." },
            ...
            <FadeIn className="w-full">
              <div className="flex justify-center w-full" data-testid="hero-stats-slim">
                <div className="relative border border-white/15 rounded-2xl sm:rounded-full px-4 sm:px-8 py-2 sm:py-2.5 inline-flex">
                  <div className="grid grid-cols-2 sm:flex sm:items-center sm:justify-center gap-x-3 gap-y-1.5 sm:gap-x-5 text-[7px] sm:text-[10px] hero-pill-mobile font-semibold tracking-wider sm:tracking-[0.15em] text-white whitespace-nowrap uppercase">
