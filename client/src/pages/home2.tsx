            ...
            <FadeIn className="w-full">
              <div className="flex justify-center w-full" data-testid="hero-stats-slim">
                <div className="relative border border-white/15 rounded-2xl sm:rounded-full px-4 sm:px-8 py-2 sm:py-2.5 inline-flex">
                  <div className="grid grid-cols-2 sm:flex sm:items-center sm:justify-center gap-x-3 gap-y-1.5 sm:gap-x-5 text-[10px] sm:text-[10px] font-semibold tracking-wider sm:tracking-[0.15em] text-white whitespace-nowrap uppercase">
