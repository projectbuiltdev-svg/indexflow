...
export default function ByokMistral() {
  ...
  const setupSteps = [
    { step: "Go to console.mistral.ai and create an account", link: "https://console.mistral.ai" },
    { step: "Navigate to API Keys in the left sidebar", link: "https://console.mistral.ai/api-keys" },
    { step: "Click 'Create new key' and name it" },
    { step: "Copy the key immediately" },
    { step: "Paste it in the API Key field above and click Save" },
    { step: "Add a payment method under Billing", link: "https://console.mistral.ai/billing" },
  ];
