...
const clients = [
  ...
  { id: 2, name: "Dragon Media", plan: "Professional", status: "Active", mrr: "$149", website: "-", twilioConnected: true, keywords: 18, gscConnected: true, created: "Jan 20, 2026" },
  ...
  { id: 5, name: "Metro Creative", plan: "Professional", status: "Active", mrr: "$149", website: "-", twilioConnected: true, keywords: 10, gscConnected: false, created: "Jan 5, 2026" },
];
