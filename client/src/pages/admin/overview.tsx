...
import type { Venue, BlogPost, RankKeyword, ContactMessage } from "@shared/schema";
...
export default function AdminOverview() {
  ...
  const loading = venuesLoading || postsLoading || keywordsLoading || messagesLoading;
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          ...
          {selectedVenue && (
            <span className="ml-1">
              — filtered to <span className="font-medium text-foreground">{selectedVenue.name}</span>
            </span>
          )}
        </p>
      </div>
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartData}>
                <defs>
                  <linearGradient id="adminPostsGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="hsl(197, 90%, 50%)" stopOpacity={0.15} />
                    <stop offset="95%" stopColor="hsl(197, 90%, 50%)" stopOpacity={0} />
                  </linearGradient>
                  <linearGradient id="adminKeywordsGrad" x1="0" y1="0" x2="0" y2="1">
