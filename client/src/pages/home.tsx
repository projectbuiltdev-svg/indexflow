...
const pricingTiers = [
  ...
  },
  {
    ...
    price: "$199",
    period: "/mo",
    features: ["5 users", "3 workspaces", "Bulk campaigns"],
    highlight: true,
  },
  {
    name: "Agency",
    price: "$349",
    period: "/mo",
    features: ["10 users", "7 workspaces", "Full white label"],
    highlight: false,
  },
  {
    name: "Enterprise",
    price: "$999",
    period: "/mo",
    features: ["20 workspaces", "Super Admin Dashboard", "Dedicated support"],
    highlight: false,
  },
];
