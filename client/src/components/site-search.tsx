...
const searchablePages = [
  ...
  { title: "SEO Agencies", path: "/solutions/seo-agencies", keywords: "seo agency rank tracking" },
  { title: "Freelancers", path: "/solutions/freelancers", keywords: "freelancer consultant solo" },
  { title: "Content Agencies", path: "/solutions/content-agencies", keywords: "content agency writing" },
  { title: "Digital Marketing", path: "/solutions/marketing-agencies", keywords: "digital marketing agency" },
  { title: "AI Widget", path: "/platform/ai-widget", keywords: "ai chatbot widget voice" },
