...
const segmentLabels: Record<string, string> = {
  ...
  "opentable": "vs OpenTable",
  "resy": "vs Resy",
  "best-booking-systems": "Best SEO Platforms",
  "api": "API Reference",
  "voice-booking": "AI Voice Assistant",
  "sms-confirmations": "SMS & Notifications",
  "waitlist": "Waitlist",
  "prepaid-reservations": "Prepaid Reservations",
  "multi-language": "Multi-Language",
  "analytics": "Analytics",
  "local-citations": "Local Citations",
  "dashboard": "Client Dashboard",
  "hospitality-websites": "Hospitality Websites",
